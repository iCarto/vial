...
-- INSERT municipio into existing road
...
SELECT is(pk_final, '9.65', 'PK final autocalculated on INSERT')
       FROM inventario.carreteras_lugo
       WHERE numero = '9999';
SELECT is(intermunicipal, 'f', 'Intermunicipal autocalculated on INSERT')
       FROM inventario.carreteras_lugo
       WHERE numero = '9999';

-- UPDATE municipio into existing road
...
-- INSERT another municipio into existing road
INSERT INTO inventario.carretera_municipio
       (codigo_carretera, codigo_municipio, orden_tramo, pk_inicial_tramo, pk_final_tramo)
       VALUES('9999', '27002', 'B', 3, 9.65);
SELECT is(intermunicipal, 't', 'Intermunicipal autocalculated on INSERT')
       FROM inventario.carreteras_lugo
       WHERE numero = '9999';

-- DELETE municipio in existing road
DELETE FROM inventario.carretera_municipio
       WHERE codigo_carretera = '9999'
             AND codigo_municipio = '27002';
SELECT is(intermunicipal, 'f', 'Intermunicipal autocalculated on INSERT')
       FROM inventario.carreteras_lugo
       WHERE numero = '9999';
