SELECT mun_cod.nombre AS "Municipio", \
       actuaciones.conservacion_propuesta_fecha_consignacion_aprobacion AS "Fecha aprobación", \
       sum(conservacion_propuesta_importe_proyecto) AS "Importe proyecto" \
...
[[WHERE]] \
GROUP BY mun_cod.nombre, actuaciones.conservacion_propuesta_fecha_consignacion_aprobacion;